...
class World {
    ...
    coinsCounter = 0;
    gameOver = false;
    background_music = new Audio('audio/210. Mexican.mp3');
    chickenDead_music = new Audio('audio/enemy_hit.mp3');
 ...
 */
     ...
     */
    checkThrowObjects() {
        if (this.keyboard.D && this.bottleCounter > 0 && !this.character.otherDirection) {
